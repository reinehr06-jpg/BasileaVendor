...
export default function VendedorContaPage() {
  ...
  return (
    <main className="p-4 flex-1 flex flex-col w-full max-w-[1200px] mx-auto gap-4 overflow-y-auto custom-scrollbar">
          ...
          <div className="flex flex-col lg:flex-row gap-[24px]">
            ...
            {/* LADO ESQUERDO: CONTEÚDO PRINCIPAL (DADOS) */}
            <div className="flex-1 flex flex-col gap-[24px]">
              ...
              <div className="bg-white border border-[#E5E7EB] shadow-[0_2px_8px_rgba(0,0,0,0.02)] rounded-[12px] p-6">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/vendedor/configuracoes/seguranca" className="px-[16px] py-[10px] border border-[#E5E7EB] hover:bg-[#F9FAFB] rounded-[8px] text-[13px] font-[600] text-[#374151] flex items-center gap-[8px] transition-colors shadow-sm">
                    Alterar Minha Senha
                  </Link>
                </div>
              </div>
            ...
            <div className="w-full lg:w-[320px] flex flex-col gap-[24px]">
              ...
              <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-[24px] shadow-[0_2px_8px_rgba(0,0,0,0.02)] flex flex-col gap-[20px]">
                <h3 className="text-[15px] font-[700] text-[#1A1A2E] border-b border-[#F3F4F6] pb-[12px]">Outras Informações</h3>
                
                <div className="flex flex-col gap-[8px]">
                  <label className="text-[13px] font-[600] text-[#4B5563]">Telefone</label>
                  <div className="relative">
                    <Phone className="w-[16px] h-[16px] text-[#9CA3AF] absolute left-[12px] top-[12px]" />
                    <input 
                      type="text" 
                      value={formData.telefone} 
                      onChange={(e) => setFormData({...formData, telefone: e.target.value})} 
                      className="w-full h-[40px] pl-[36px] pr-[12px] border border-[#E5E7EB] rounded-[6px] text-[14px] text-[#1A1A2E] outline-none focus:border-[#6D28D9] focus:ring-1 focus:ring-[#6D28D9] transition-all" 
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-[8px]">
                  ...
                  <input 
                    ...
                    value={formData.cpf} 
                    disabled 
                    className="w-full h-[40px] bg-[#F9FAFB] border border-[#E5E7EB] rounded-[6px] px-[12px] text-[14px] text-[#6B7280] font-[500] cursor-not-allowed text-center" 
                  />
                  <p className="text-[11px] text-[#9CA3AF] mt-1 text-center">Para alterar o CPF, entre em contato com o administrador.</p>
                </div>
