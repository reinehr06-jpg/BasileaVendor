...
export default function ConfiguracoesPage() {
  ...
  return (
    <main data-tour="tour-vendedor-config-view" className="p-[30px_28px_20px_28px] flex-1 flex flex-col items-center overflow-y-auto">
          ...
          <div className="w-full max-w-[1100px] flex flex-col items-center flex-1">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[16px]">
              {filteredModulos.map((modulo) => (
                <Link
                  key={modulo.id}
                  href={`/vendedor/configuracoes/${modulo.id}`}
                  className={`
