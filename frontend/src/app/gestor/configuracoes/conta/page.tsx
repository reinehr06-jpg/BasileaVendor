            ...
            <div className="flex-1 flex flex-col gap-[24px]">
              ...
              <div className="bg-white border border-[#E5E7EB] shadow-[0_2px_8px_rgba(0,0,0,0.02)] rounded-[12px] p-6">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/gestor/configuracoes/seguranca" className="px-[16px] py-[10px] border border-[#E5E7EB] hover:bg-[#F9FAFB] rounded-[8px] text-[13px] font-[600] text-[#374151] flex items-center gap-[8px] transition-colors shadow-sm">
                    Alterar Minha Senha
                  </Link>
                </div>
              </div>
