          ...
          <div className="flex items-center justify-between shrink-0 bg-white rounded-[12px] p-4 border border-[#E5E7EB] shadow-sm">
            <div className="flex items-center gap-3">
              <div className="w-[40px] h-[40px] rounded-[10px] bg-[#EFF6FF] flex items-center justify-center shrink-0">
                <DollarSign className="w-[20px] h-[20px] text-[#3B82F6]" strokeWidth={2.2} />
              </div>
              <div className="flex flex-col">
                <h1 className="text-[18px] font-[800] text-[#1A1A2E] leading-tight">Contas a Receber</h1>
                <p className="text-[12px] font-[500] text-[#6B7280]">Gestão da previsão de entradas financeiras.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-1 gap-4 overflow-y-auto custom-scrollbar pb-4 animate-in fade-in duration-300">
              ...
              <div className="grid grid-cols-4 gap-4 shrink-0">
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-4 flex items-center justify-between shadow-sm border-l-[4px] border-l-[#EF4444]">
                  <div className="flex flex-col">
                    <span className="text-[11px] font-[700] text-[#6B7280] uppercase tracking-wider">Em Atraso</span>
                    <div className="flex items-baseline gap-2 mt-1">
                      <span className="text-[20px] font-[800] text-[#EF4444]">R$ 550,00</span>
                      <span className="text-[12px] font-[600] text-[#EF4444] bg-[#FEF2F2] px-2 py-0.5 rounded-[4px]">2 entradas</span>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-4 flex items-center justify-between shadow-sm border-l-[4px] border-l-[#F59E0B]">
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-baseline gap-2 mt-1">
                      <span className="text-[20px] font-[800] text-[#F59E0B]">R$ 350,00</span>
                      <span className="text-[12px] font-[600] text-[#F59E0B] bg-[#FFFBEB] px-2 py-0.5 rounded-[4px]">1 entrada</span>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-4 flex items-center justify-between shadow-sm border-l-[4px] border-l-[#10B981]">
                  <div className="flex flex-col">
                    <span className="text-[11px] font-[700] text-[#6B7280] uppercase tracking-wider">Próximos 7 Dias</span>
                    <div className="flex items-baseline gap-2 mt-1">
                      <span className="text-[20px] font-[800] text-[#10B981]">R$ 4.900,00</span>
                      <span className="text-[12px] font-[600] text-[#10B981] bg-[#ECFDF5] px-2 py-0.5 rounded-[4px]">4 entradas</span>
                    </div>
                  </div>
                  <div className="w-[36px] h-[36px] rounded-full bg-[#ECFDF5] flex items-center justify-center shrink-0">
                    <CalendarDays className="w-[16px] h-[16px] text-[#10B981]" strokeWidth={2.5} />
                  </div>
                </div>
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-4 flex items-center justify-between shadow-sm border-l-[4px] border-l-[#3B82F6]">
                  <div className="flex flex-col">
                    <span className="text-[11px] font-[700] text-[#6B7280] uppercase tracking-wider">Total a Receber</span>
                    <div className="flex items-baseline gap-2 mt-1">
                      <span className="text-[20px] font-[800] text-[#1A1A2E]">R$ 5.800,00</span>
                      <span className="text-[12px] font-[600] text-[#6B7280] bg-[#F3F4F6] px-2 py-0.5 rounded-[4px]">7 entradas</span>
                    </div>
                  </div>
                  <div className="w-[36px] h-[36px] rounded-full bg-[#EFF6FF] flex items-center justify-center shrink-0">
                    <DollarSign className="w-[16px] h-[16px] text-[#3B82F6]" strokeWidth={2.5} />
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4 flex-1 min-h-[300px]">
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-5 flex-1 flex flex-col shadow-sm">
                  <div className="flex justify-between items-center mb-6 shrink-0">
                    <div className="flex flex-col">
                      <span className="text-[15px] font-[800] text-[#1A1A2E]">Fluxo de Recebimentos</span>
                      <span className="text-[12px] font-[500] text-[#6B7280]">Previsão diária para os próximos 7 dias</span>
                    </div>
                    <div className="text-right">
                      <span className="block text-[16px] font-[800] text-[#7C3AED]">R$ 5.250,00</span>
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] w-[450px] flex flex-col shadow-sm overflow-hidden">
                  <div className="p-4 border-b border-[#F1F1F4] flex justify-between items-center bg-[#F9FAFB] shrink-0">
                    <span className="text-[14px] font-[800] text-[#1A1A2E]">Entradas Atrasadas e Para Hoje</span>
            ...
            <div className="bg-white rounded-[12px] border border-[#E5E7EB] shadow-sm flex flex-col flex-1 overflow-hidden min-h-0 animate-in fade-in duration-300">
              ...
              <div className="p-4 border-b border-[#F1F1F4] flex items-center justify-between gap-3 shrink-0">
                <div className="flex items-center gap-1 bg-[#F3F4F6] p-1 rounded-[8px]">
                  {["Todas", "Atrasadas", "Para Hoje", "A Receber", "Recebidas"].map((tab) => (
                    <button
                      key={tab}
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar p-0 m-0 relative">
                <table className="w-full text-left border-collapse">
                  <thead className="sticky top-0 bg-[#F9FAFB] shadow-[0_1px_0_#F1F1F4] z-10">
                    <tr>
                      <th className="py-3 px-5 text-[11px] font-[700] text-[#6B7280] uppercase tracking-wider border-b border-[#F1F1F4]">Data Prevista</th>
                      <th className="py-3 px-5 text-[11px] font-[700] text-[#6B7280] uppercase tracking-wider border-b border-[#F1F1F4]">Descrição</th>
                      <th className="py-3 px-5 text-[11px] font-[700] text-[#6B7280] uppercase tracking-wider border-b border-[#F1F1F4]">Origem/Cliente</th>
                      <th className="py-3 px-5 text-[11px] font-[700] text-[#6B7280] uppercase tracking-wider border-b border-[#F1F1F4]">Categoria</th>
                      <th className="py-3 px-5 text-[11px] font-[700] text-[#6B7280] uppercase tracking-wider border-b border-[#F1F1F4]">Conta Destino</th>
              ...
              <div className="border-t border-[#F1F1F4] p-4 flex items-center justify-between shrink-0 bg-white">
                ...
                <div className="text-[12px] font-[600] text-[#111827]">1-4 de 4</div>
