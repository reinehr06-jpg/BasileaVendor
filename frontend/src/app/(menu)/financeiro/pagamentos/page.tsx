        ...
        <main className="p-[24px_28px_20px_28px] flex-1 flex flex-col">
          ...
          <div className="bg-white rounded-[18px] flex-1 border border-[#E5E7EB] shadow-[0_2px_8px_rgba(0,0,0,0.02)] overflow-hidden flex flex-col">
              ...
              <div className="flex flex-wrap items-center gap-[10px] w-full xl:w-auto">
                <div className="relative flex items-center w-full sm:w-auto h-[36px] bg-white border border-[#E5E7EB] rounded-[8px] px-[12px] transition-all">
                  ...
                  <input
                    ...
                    placeholder={t("Buscar por igreja, vendedor...")}
            ...
            <div className="flex-1 flex flex-col overflow-x-auto">
              ...
              {/* Cabeçalho */}
              <div className="grid grid-cols-[1.8fr_1fr_100px_140px_100px_100px_80px] items-center px-[24px] h-[40px] border-t border-b border-[#F1F1F4] bg-[#FCFCFD] min-w-[900px]">
                <span className="text-[12px] font-[700] text-[#6B7280]">{t("Igreja")}</span>
                <span className="text-[12px] font-[700] text-[#6B7280]">{t("Vendedor")}</span>
                <span className="text-[12px] font-[700] text-[#6B7280]">{t("Valor")}</span>
                <span className="text-[12px] font-[700] text-[#6B7280]">{t("Forma")}</span>
              ...
              {paginatedPagamentos.length > 0 ? paginatedPagamentos.map((p, i) => (
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8">
                  ...
                  <h3 className="text-[16px] font-[600] text-[#111827]">{t("Nenhum pagamento encontrado")}</h3>
                  <p className="text-[13px] text-[#6B7280] mt-1">{t("Tente alterar os filtros para ver mais resultados.")}</p>
                </div>
              )}
            </div>
