...
import { 
  AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, BarChart, Bar, Cell, PieChart, Pie, Legend, ComposedChart, Line 
} from "recharts";
              ...
              <div className="grid grid-cols-4 gap-4 shrink-0">
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-5 flex items-center justify-between shadow-sm">
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-baseline gap-1 mt-1">
                      <span className="text-[22px] font-[800] text-[#1A1A2E]">{transferencias.length}</span>
                    </div>
                  </div>
                  <div className="w-[42px] h-[42px] rounded-[10px] bg-[#EFF6FF] flex items-center justify-center shrink-0">
                    <ArrowRightLeft className="w-[20px] h-[20px] text-[#3B82F6]" strokeWidth={2.4} />
                  </div>
                </div>
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-5 flex items-center justify-between shadow-sm">
                  ...
                  <div className="w-[42px] h-[42px] rounded-[10px] bg-[#FEE2E2] flex items-center justify-center shrink-0">
                    <ArrowRightLeft className="w-[20px] h-[20px] text-[#DC2626]" strokeWidth={2.4} />
                  </div>
                </div>
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-5 flex items-center justify-between shadow-sm">
                  ...
                  <div className="w-[42px] h-[42px] rounded-[10px] bg-[#ECFDF5] flex items-center justify-center shrink-0">
                    <ArrowRightLeft className="w-[20px] h-[20px] text-[#10B981]" strokeWidth={2.4} />
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white rounded-[12px] border border-[#E5E7EB] p-5 w-[380px] flex flex-col shadow-sm">
                  ...
                  <div className="flex-1 w-full min-h-0 ml-[-20px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={transferenciasHistoricoData} layout="vertical" margin={{ top: 5, right: 0, left: 0, bottom: 0 }}>
