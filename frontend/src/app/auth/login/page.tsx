    ...
    <>
      ...
      <div className="split">
        ...
        <div className="left">
          ...
          <div className="benefits-container">
            <div className="benefit-card">
              ...
              <div className="benefit-text">Gestão de<br/>Vendedores</div>
            </div>
            ...
            <div className="benefit-card">
              ...
              <div className="benefit-text">Controle de<br/>Comissões</div>
            </div>
        ...
        <div className="right">
          ...
          <p className="footer">© 2026 Basiléia Vendor OS. Todos os direitos reservados.</p>
        </div>
      </div>
    </>
  );
