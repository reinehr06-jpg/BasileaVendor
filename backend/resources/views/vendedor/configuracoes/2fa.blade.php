...
<div class="container">
    <div class="header">
        ...
        <p>Escaneie o QR code com seu app autenticador ou insira a chave manualmente</p>
    </div>
    ...
    <a href="{{ route('vendedor.configuracoes', ['tab' => 'seguranca']) }}" class="back-link">
...
function copySecret() {
    ...
    navigator.clipboard.writeText(secret).then(() => {
        alert('Chave copiada! AgoraCole no app autenticador');
    }).catch(() => {
