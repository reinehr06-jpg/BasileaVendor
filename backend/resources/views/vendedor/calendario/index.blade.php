...
<div class="cal-modal-overlay" id="calModal">
    <div class="cal-modal">
        ...
        <form action="{{ route('calendario.store') }}" method="POST">@csrf
            <div class="cal-field"><label>Título *</label><input type="text" name="titulo" required placeholder="Ex: Follow-up cliente"></div>
