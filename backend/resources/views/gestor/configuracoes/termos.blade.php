...
<div class="terms-page">
    <a href="{{ route('gestor.configuracoes') }}" class="back-btn">
        ...
        <div class="term-card">
            <div class="term-header">
                ...
                <div class="term-actions">
                    <a href="{{ route('gestor.configuracoes.termos.pdf', $termo) }}" class="btn-download btn-pdf">
                        <i class="fas fa-file-pdf"></i> Baixar PDF
                    </a>
                    <a href="{{ route('gestor.configuracoes.termos.html', $termo) }}" class="btn-download btn-html">
