    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 12px; overflow: hidden; margin-top: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <tr>
            <td style="background: linear-gradient(135deg, #581c87, #7c3aed); padding: 40px 30px; text-align: center;">
                ...
                <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0; font-size: 16px;">Parabéns! Sua comissão foi gerada.</p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 30px;">
                ...
                <p style="font-size: 16px; color: #333; line-height: 1.6;">
                    A venda abaixo foi confirmada e sua comissão está sendo processada:
                </p>
                ...
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 20px; margin: 20px 0;">
                    <table width="100%" cellpadding="8">
                        <tr>
                            <td style="font-weight: bold; color: #581c87; width: 140px;">Venda #</td>
                            <td>{{ str_pad($venda->id, 5, '0', STR_PAD_LEFT) }}</td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold; color: #581c87;">Cliente</td>
                            <td>{{ $venda->cliente->nome_igreja ?? 'N/A' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="font-weight: bold; color: #581c87;">Valor</td>
                            <td style="font-size: 18px; font-weight: bold; color: #16a34a;">R$ {{ number_format($venda->valor_final ?? $venda->valor, 2, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold; color: #581c87;">Comissão</td>
                            <td style="font-size: 18px; font-weight: bold; color: #581c87;">R$ {{ number_format($venda->comissao_gerada ?? 0, 2, ',', '.') }}</td>
                        </tr>
                    </table>
                </div>
                ...
                <p style="font-size: 14px; color: #666; text-align: center;">
                    Clique no botão acima para ver todos os detalhes da venda no sistema.
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td style="background: #f8fafc; padding: 20px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
                <p style="font-size: 12px; color: #94a3b8; margin: 0;">
                    Basiléia Vendas - Sistema de Gestão Comercial<br>
